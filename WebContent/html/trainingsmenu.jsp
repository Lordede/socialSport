...
<script src="../JavaScript/TrainingsManagement.js"
	...
	<article>
		...
		<div id="training">
			<div id="addTraining">
				...
				<br> <label id="nameOfTrainingLabel" hidden="hidden">Name
					des Traings</label> <input id="nameOfTrainingInput" type="hidden">
				<button id="sendTraining" hidden="hidden">Training
					erstellen</button>
			</div>
			<div id="searchPastTrainings">
				<label id="searchBarTrainingLabel">Training Suchen</label> <input
					id="searchBarTraining" type="search">
		...
		<script>
			let searchTrainingInput = document
					.getElementById("searchPastTrainings")
